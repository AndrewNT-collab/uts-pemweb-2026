...
<head>
    ...
    <title>{{ $profile->name ?? 'Andrew Portfolio' }}</title>
...
<body class="bg-black text-white overflow-x-hidden">
    ...
    <div class="fixed inset-0 -z-10">
        ...
        <div class="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-[size:40px_40px]">
        </div>
    </div>
    ...
    <!-- HERO -->
    <section
        class="min-h-screen pt-32 flex flex-col justify-center items-center text-center px-6 bg-cover bg-center bg-no-repeat relative"
        style="background-image: url('/bg-profile.jpg');">
        ...
        <div class="relative z-10 flex flex-col items-center">
            ...
            <h1 class="text-5xl md:text-7xl font-bold mb-4">
                {{ $profile->name ?? 'Andrew Novan Then' }}
            </h1>

            <p class="text-gray-400 text-lg md:text-xl mb-2">
                {{ $profile->nim ?? '20240801024' }}
            </p>
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-5xl">
            <div class="bg-zinc-900/70 backdrop-blur border border-zinc-800 rounded-3xl p-8 shadow-xl">
                ...
                <div class="space-y-4 text-gray-400">
                    ...
                    <p>
                        ...
                        {{ $profile->university ?? 'Universitas Esa Unggul' }}
                    </p>
                </div>
            </div>
            ...
            <div class="bg-zinc-900/70 backdrop-blur border border-zinc-800 rounded-3xl p-8 shadow-xl">
                ...
                <p class="text-gray-400 leading-8">
                    {{ $profile->about ?? 'Website ini dibuat sebagai portfolio personal sekaligus media showcase untuk menampilkan project akhir saya, yaitu Endfield Factory Blueprint System.' }}
                </p>
            </div>
        </div>
    ...
    <footer class="border-t border-zinc-800 py-8 text-center text-gray-500 text-sm">
        © 2026 {{ $profile->name ?? 'Andrew Novan Then' }} — Endfield Factory Blueprint System
    </footer>
